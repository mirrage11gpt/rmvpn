...
usage() {
  echo "usage: sudo ./install.sh --domain vpn.example.com --acme-email admin@example.com --masquerade-url https://cover.example.com [--version 0.1.0] [--release-public-key RW...]" >&2
  exit 2
}
