...
несколько локаций RiseVPN Node. Команды рассчитаны на release `v0.2.3`.
...
curl --fail --location --remote-name https://github.com/mirrage11gpt/rmvpn/releases/download/v0.2.3/install.sh
curl --fail --location --remote-name https://github.com/mirrage11gpt/rmvpn/releases/download/v0.2.3/checksums.txt
curl --fail --location --remote-name https://github.com/mirrage11gpt/rmvpn/releases/download/v0.2.3/checksums.txt.minisig
